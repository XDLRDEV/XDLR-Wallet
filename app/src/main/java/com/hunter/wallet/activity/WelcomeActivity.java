            ...
            try {
                if(userManageService != null) {
                    ...
                    if (!userInfo.isHasInit()) {
                        // 进入初始化界面
                        startActivity(new Intent(WelcomeActivity.this, com.hunter.wallet.activity.InitActivity.class));
                    } else if (userInfo.isPinHasLock()) {
                        // 进入解锁界面
                        startActivity(new Intent(this, com.hunter.wallet.activity.UnlockActivity.class));
                    } else {
//                         进入主界面
                        startActivity(new Intent(WelcomeActivity.this, com.hunter.wallet.activity.MainFragmentActivity.class));
                    }
                }
